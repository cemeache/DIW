...
<body>
    ...
    <main>
        ...
        <section id="stock">
            <?php
                require_once('../controladores/cListarStock.php');
                ...
                foreach ($datos as $i => $value) {
                    echo "<article>";
                    echo '<img src="../../img/libro.png" alt="Portada">';
                    echo "<div class='bbdd'>";
                    ...
                    echo '<figure class="botones">
                            <a href="#">
                                <img src="../../img/modificar.png" alt="actualizar">
                                <figcaption>ACTUALIZAR</figcaption>
                            </a>
                        </figure>
                        <figure class="botones">
                            <a href="#">
                                <img src="../../img/eliminar.png" alt="restablecer">
